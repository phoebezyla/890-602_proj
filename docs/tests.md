...
To test your own I/O and installation process, please interactively run `testing.sh`. It will check the availability of SLURM, an AERIE environment, and whether your produced files match the produced example files in the `example` folder. You will need to make sure that `testing.sh` points to the yout produced files. 
